    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure your deployment settings and provide your private key. Your private key is only used for this deployment and is not stored.
          </DialogDescription>
        </DialogHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        The RPC endpoint for your network
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Your private key is used to sign the deployment transaction. The contract will be owned by this address.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
