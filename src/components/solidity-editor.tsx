    ...
    if (!solidityRegistered) {
      ...
      monacoInstance.languages.setMonarchTokensProvider('solidity', {
        keywords: [
          ...
          'catch', 'constant', 'constructor', 'continue', 'contract', 'delete',
          'do', 'else', 'emit', 'enum', 'error', 'event', 'external', 'fallback',
          'final', 'for', 'function', 'if', 'immutable', 'import', 'in', 'indexed',
          'interface', 'internal', 'is', 'library', 'mapping', 'memory', 'modifier',
          'new', 'override', 'payable', 'pragma', 'private', 'public', 'pure',
          'receive', 'return', 'returns', 'revert', 'storage', 'struct', 'switch',
          'this', 'throw', 'try', 'type', 'unchecked', 'using', 'view', 'virtual',
          'while',
        ],
        typeKeywords: [
